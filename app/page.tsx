...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <section id="features" className="min-h-screen flex items-center justify-center bg-secondary/30">
      ...
      <section id="contact" className="min-h-screen flex items-center justify-center bg-secondary/30">
        <div className="container px-4">
